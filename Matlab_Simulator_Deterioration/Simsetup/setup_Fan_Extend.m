...
% *************************************************************************
 ...
 MWS.FAN.NcVec = [0.300 0.400 0.500 0.600 0.700 0.800 0.850 0.900 0.950...
...
%========== Wc = f(NcMap, RlineMap) ==================
 ...
 [0.6000 0.6500 0.7400 0.8450 0.9575 1.0700 1.1400 1.1850 1.2200 1.2900 1.3100 1.3467]*1.2*10^3;
 
 [0.8396 0.9751 1.1077 1.2356 1.3340 1.4200 1.5200 1.6051 1.6366 1.6950 1.7200 1.7500]*1.05*10^3;
 
                     1129.0825  1258.8474  1382.1909  1498.6384  1607.7749...
...
%========== eff = f(NcMap, RlineMap) ==================
 MWS.FAN.EffArray = [0.7900  0.8100  0.8409  0.8835  0.9160  0.9360  ...
                     0.9257  0.8894  0.8233  0.7152  0.5453  0.2792
                     0.7900  0.8380  0.8609  0.9090  0.9360  0.9400  ...
                     0.9257  0.8894  0.8233  0.7152  0.5453  0.2792  %上述两行为
...
%========== PR = f(NcMap, RlineMap) ==================
 MWS.FAN.PRArray = [ [1.0290  1.0280  1.0260  1.0240  1.0220  1.0190... 
                     1.0160  1.0130  1.0100  1.0070  1.0040  1.0000]*1.0094;
                     [1.0349  1.0408  1.0412  1.0363  1.0310  1.0250...
                     1.0200  1.0160  1.0120  1.0040  0.9950  0.9800]*1.03;
                     1.1119  1.1119  1.1098  1.1058  1.0998  1.0919... 
...
MWS.FAN.s_Wc = 0.521629;            %0.521629

%--------- scalar for pressure ratio ----------
MWS.FAN.s_PR = 1.4369;            %1.4369

%--------- scalar for efficiency ----------  
MWS.FAN.s_eff = 0.967977;   %0.967977

%--------- scalar for corrected FAN speed ----------
% MWS.FAN.s_Nc = 0.0002535;
MWS.FAN.s_Nc = 3943.959;    %3943.959

MWS.FAN.s_HP =[-0.0227;0;-0.017];