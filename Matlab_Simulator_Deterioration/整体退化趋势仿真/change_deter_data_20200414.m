...
%%
fan=[1.5 1.5*ones(1,66) 1.5:-0.05/33:1.45 1.45*ones(1,99)];
...
lpc=[1.3:-0.5/119:0.8 0.8:-0.25/79:0.55];
LPC_flow_loss=LPC_flow_loss.*lpc;
LPC_effi_loss=LPC_effi_loss.*lpc;

hpc=[1.2*ones(1,33) 1.2:-0.1/33:1.1 1.1:-0.1/33:1 1:-0.1/19:0.9 0.9:-0.1/78:0.8];
HPC_flow_loss=HPC_flow_loss.*hpc;
HPC_effi_loss=HPC_effi_loss.*hpc;

hpt=[1.7:-0.2/33:1.5 1.5:-0.3/32:1.2 1.2:-0.2/33:1 1:-0.07/19:0.93 0.93:-0.13/78:0.8];
